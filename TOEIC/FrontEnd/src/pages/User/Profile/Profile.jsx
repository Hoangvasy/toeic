      ...
      <div className="grid grid-cols-3 gap-6">
        ...
        <div className="col-span-2 space-y-6">
          ...
          >
            ...
            <button className="mt-4 w-full py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition">
              Lưu thay đổi
            </button>
          </motion.div>
        ...
        <div className="space-y-6">
          ...
          <motion.div
            ...
            "
          >
            <h4 className="text-gray-900 dark:text-gray-200">⏱ Study Time</h4>
