...
function ForgotPassword() {
  ...
  const send = async () => {
    ...
    try {
      ...
      alert("Đã gửi link đặt lại mật khẩu tới email của bạn");
    } catch (err) {
      alert("Không thể gửi link đặt lại mật khẩu");
    } finally {
      setLoading(false);
    }
  };
  ...
  const features = [
    {
      ...
      desc: "Liên kết reset được bảo vệ an toàn",
    },
    {
      icon: Mail,
      title: "Gửi email nhanh chóng",
      desc: "Nhận link reset chỉ trong vài giây",
    },
    {
      icon: ArrowLeft,
      title: "Truy cập lại dễ dàng",
      desc: "Nhanh chóng tiếp tục việc học",
    },
  ];
          ...
          <div>
            ...
            <div className="mt-10">
              ...
              <p className="mt-4 text-base leading-relaxed text-slate-600">
                Nhập email của bạn để nhận liên kết đặt lại mật khẩu và tiếp tục
                hành trình học TOEIC.
              </p>
            </div>
          </div>
